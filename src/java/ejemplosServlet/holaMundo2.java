...
public class holaMundo2 extends HttpServlet {
    ...
    // Es el proceso principal y ÚNICO, el que procesa toda la petición y... 
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //...Aquí genera la respuesta
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet holaMundo2 at " + request.getLocalName() + "</h1>");
            out.println("<h1>Servlet " + request.getMethod()+ "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
